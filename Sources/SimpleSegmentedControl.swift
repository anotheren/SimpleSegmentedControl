...
public protocol SimpleSegmentedControlDelegate: class {
    
    func segmentedControl(_ segmentedControl: SimpleSegmentedControl, didSelectItemAt index: Int)
}

open class SimpleSegmentedControl: UIControl {
    
    open weak var delegate: SimpleSegmentedControlDelegate?
    
    open var textColor: UIColor = UIColor.textColor {
        didSet {
            updateLabelsColor(with: textColor, selected: false)
        }
    }
    
    open var highlightTextColor: UIColor = UIColor.highlightTextColor {
        didSet {
            updateLabelsColor(with: highlightTextColor, selected: true)
        }
    }
    
    open var segmentsBackgroundColor: UIColor = UIColor.segmentedControlBackgroundColor {
        didSet {
            backgroundView.backgroundColor = segmentsBackgroundColor
        }
    }
    
    open var sliderBackgroundColor: UIColor = UIColor.sliderColor {
        didSet {
...
extension SimpleSegmentedControl {
